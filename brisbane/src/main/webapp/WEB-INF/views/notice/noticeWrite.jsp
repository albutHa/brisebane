	...
	<form name="writeForm" method="post" action="${ctxpath}/noticeWritePro.do" onsubmit="return writeCheck()">
		...
		<table>
			...
			<tr>
				...
				<td bgcolor="f9fafb">&nbsp;<input type="text" id="writer" name="writer" value="${writer}" readonly></td>
			</tr>
			...
			<tr>
				...
				<td bgcolor="f9fafb">
					...
					<c:if test="${num!=0}"><!-- 답글일때 -->
						<input type="text" name="subject" id="subject" size="45" value="[re]">
					</c:if>
				</td>
			</tr>
			...
			<tr>
				...
				<td bgcolor="f9fafb"><textarea name="content" rows="10" cols="50"></textarea></td>
			</tr>
			<tr>
