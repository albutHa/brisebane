	...
	<form name="writeForm" method="post" action="${ctxpath}/noticeUpdatePro.do" onsubmit="return writeCheck()">
		<table>
			...
			<tr>
				...
				<td bgcolor="f9fafb"><input type="text" name="subject" id="subject" size="40" value="${noticeDto.subject}"></td>
			</tr>
			<tr>
				<td bgcolor="#ecf7fd">글내용</td>
				<td bgcolor="f9fafb"><textarea name="content" rows="10" cols="50">${noticeDto.content}</textarea></td>
			</tr>
			<tr>
